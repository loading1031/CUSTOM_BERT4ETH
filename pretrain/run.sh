...
# 커맨드 경로: pretrain/
python -m rn_embed --bizdate=0000 --init_checkpoint=mlm/cpkt_local/epoch_50.pth
python -m run_embed --bizdae=0000 --init_checkpoint=cluster/cpkt_local/epoch_50.pth

# 5. mlm/cluster 최종 임베딩 피싱 시각화 결과 확인
# 커맨드 경로: pretrain/eval/
