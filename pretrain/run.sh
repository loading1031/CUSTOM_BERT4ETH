...
# 커맨드 경로: eval/
 ...
 # 6. 피싱 분류 성능 측정
 # 커맨드 경로: eval/
 python phish_detection_mlp.py --input_dir=../outputs/mlm_epoch_50
 python phish_detectionr_rfp.py --input_dir=../outputs/mlm_epoch_50

 python phish_detection_mlp.py --input_dir=../outputs/cluster_epoch_50
 python phish_detection_rf.py --input_dir=../outputs/cluster_epoch_50
