...
class BERTEmbedding(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.token_embed = TokenEmbedding(vocab_size=args.identity_size, embed_size=args.hidden_size)
...
class BERT4ETH(nn.Module):
    def __init__(self, args):
        ...
        # Optional projection for clustering
        self.cluster_head = nn.Linear(args.hidden_size, args.hidden_size)
